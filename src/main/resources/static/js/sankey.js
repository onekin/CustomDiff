...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/sankey.src.js', [_modules['parts/Globals.js'], _modules['mixins/tree-series.js']], function (H, mixinTreeSeries) {
        /* *
         * Sankey diagram module
         *
         * (c) 2010-2019 Torstein Honsi
        ...
        seriesType('sankey', 'column',
             ...
             */
            {
                ...
                getClassName: function () {
                    ...
                    Point.prototype.getClassName.call(this) + (!(["PACKAGEPRODUCT","ASSETPRODUCT","PRODUCTFEATURE","FEATUREASSET","FEATUREPACKAGE","PRODUCTFEATURESIBLING","FEATURESIBLINGPACKAGE","FEATURESIBLINGCOREASSET"].includes(this.sankeyLinkType))? ' link-not-allowed':'');
                },
                isValid: function () {
