...
public class CustomsByFeatureAndCoreAssetExtractor implements RowMapper<CustomsByFeatureAndCoreAsset> {


    @Override
    public CustomsByFeatureAndCoreAsset mapRow(ResultSet rs, int rowNum) throws SQLException {
